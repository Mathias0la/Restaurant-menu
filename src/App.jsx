...
function App() {
  ...
  const Hovedretter = meny.filter((dish) => dish.kategori === "Hovedrett");
  const Forrett = meny.filter((dish) => dish.kategori === "Forrett");
  const Dessert = meny.filter((dish) => dish.kategori === "Dessert");
